...
private lateinit var remindDataItem: ReminderDataItem
...
//             2) save the reminder to the local db
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve: Boolean = true) {
        ...
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve) {
                ...
                Snackbar.make(
                    requireView(),
                    R.string.needLocation, Snackbar.LENGTH_INDEFINITE
    ...
    private fun addGeofenceReminder() {
        val geofence = Geofence.Builder().setRequestId(remindDataItem.id)
            .setCircularRegion(remindDataItem.latitude!!, remindDataItem.longitude!!, 100f)
